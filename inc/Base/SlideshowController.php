...
use Inc\Api\Callbacks\SlideshowCallbacks;
...
class SlideshowController extends BaseController
{
	public $settings;
	public $callbacks;
	public $slideshow_callbacks;
	public $subpages = array();
	public $custom_post_types = array();
	public function register()
	{
		if (!$this->activated('slideshow_manager')) return;
		$this->settings = new SettingsApi();
		$this->callbacks = new AdminCallbacks();
		$this->slideshow_callbacks = new SlideshowCallbacks();
		$this->setSubpages();
		$this->setSettings();
		$this->setSections();
		$this->setFields();
		...
		if (!empty($this->custom_post_types)) {
			add_action('init', array($this, 'registerSlideshow'));
		}
	}
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'sevi_plugin',
				'page_title' => 'Custom Post Types',
				'menu_title' => 'Slideshow Manager',
				'capability' => 'manage_options',
				'menu_slug' => 'sevi_slideshow',
				'callback' => array($this->callbacks, 'adminSlideshow')
			)
		);
	}
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'sevi_plugin_slideshow_settings',
				'option_name' => 'sevi_plugin_slideshow',
				'callback' => array($this->slideshow_callbacks, 'slideshowSanitize')
			)
		);
	...
	public function setSections()
	{
		$args = array(
			array(
				'id' => 'sevi_slideshow_index',
				'title' => 'Custom Post Type Manager',
				'callback' => array($this->slideshow_callbacks, 'slideshowSectionManager'),
				'page' => 'sevi_slideshow'
			)
		);
	...
	public function setFields()
	{
		$args = array(
			array(
				...
				'callback' => array($this->slideshow_callbacks, 'textField'),
				'page' => 'sevi_slideshow',
				'section' => 'sevi_slideshow_index',
				'args' => array(
					'option_name' => 'sevi_plugin_slideshow',
					'label_for' => 'post_type',
			...
			array(
				'id' => 'public',
				'title' => 'Public',
				'callback' => array($this->slideshow_callbacks, 'checkboxField'),
				'page' => 'sevi_slideshow',
				'section' => 'sevi_slideshow_index',
				'args' => array(
					'option_name' => 'sevi_plugin_slideshow',
	...
	{
		$options = get_option('sevi_plugin_slideshow') ?: array();
	...
	public function registerSlideshow()
	{
