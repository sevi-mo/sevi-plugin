...
class MediaWidget extends WP_Widget
{
	...
	function __construct() {
		$this->widget_ID = 'sevi_media_widget';
		$this->widget_name = 'Sevi Media Widget';
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['image'] ) ) {
			echo '<img src="'. esc_url( $instance['image'] ) . '" alt="" style="max-width:100%;">';
		}
	...
	public function form( $instance ) {
		...
		<p>
			...
			<button type="button" class="button button-primary js-image-upload">Submit Image</button>
		</p>
		<?php 
	}
