<div class="wrap">
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_post"]) ? 'active' : '' ?>">
            ...
            echo '<table class="slideshow-table"><tr><th>ID</th><th>Singular Name</th><th>Plural Name</th><th class="text-center">Public</th><th class="text-center">Archive</th><th class="text-center">Actions</th></tr>';
            ...
            foreach ($options as $option) {
                ...
                settings_fields('sevi_plugin_slideshow_settings');
        ...
        <div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_post"]) ? 'active' : '' ?>">
            <form method="post" action="options.php">
                <?php
                settings_fields('sevi_plugin_slideshow_settings');
                do_settings_sections('sevi_slideshow');
                submit_button();
                ?>
            </form>
        </div>
